...
class GameChatbotService {
  final Dio _dio;

  GameChatbotService({Dio? dio})
      : _dio = dio ??
            Dio(
              BaseOptions(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['response'] is String) {
          ...
          return {
            'message': 'Here are some games similar to "${resp['game']}":',
      ...
      throw Exception('Failed to communicate with game chatbot: $e');
    }
  }
}
